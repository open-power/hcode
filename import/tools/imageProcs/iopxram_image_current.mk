...
#
# $Source: import/tools/imageProcs/iopxram_image_current.mk $
#
...
$(eval IMAGE=$1.iopxram_image_current)

$(eval $(IMAGE)_PATH=$(IMAGEPATH)/iopxram_image_current)
$(eval $(IMAGE)_LINK_SCRIPT=iopxram_image.cmd)
$(eval $(IMAGE)_LAYOUT=$(IMAGEPATH)/iopxram_image_current/iopxram_image.o)
$(eval iopxram_image_COMMONFLAGS += -I$(ROOTPATH)/chips/p10/utils/imageProcs/)

# Files to be appended to image
$(eval $(IMAGE)_FILE_IOPFW=$(IMAGEPATH)/gen_iop_bin_current/iop_fw.bin)
$(eval $(IMAGE)_FILE_IOPFW_VER=$(IMAGEPATH)/gen_iop_bin_ver_current/iop_fw_ver.bin)
