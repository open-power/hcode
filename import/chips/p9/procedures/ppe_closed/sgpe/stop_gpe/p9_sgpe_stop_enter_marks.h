...
const std::map<SGPE_SE_MARKS, std::string> mMARKS = boost::assign::map_list_of
        ...
        (STOP_PIG_HANDLER, "STOP_PIG_HANDLER")
        (SE_LESSTHAN8_WAIT, "SE_LESSTHAN8_WAIT")
        (SE_STOP_SUSPEND_PSTATE, "SE_STOP_SUSPEND_PSTATE")
        ...
        (SE_WAIT_PGPE_SUSPEND, "SE_WAIT_PGPE_SUSPEND")
