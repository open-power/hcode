...
IRQ_HANDLER(p9_sgpe_stop_pig_handler, 0) //OCCHW_IRQ_PMC_PCB_INTR_TYPE2_PENDING
IRQ_HANDLER(p9_sgpe_stop_pig_handler, 0) //OCCHW_IRQ_PMC_PCB_INTR_TYPE3_PENDING
IRQ_HANDLER_DEFAULT            //OCCHW_IRQ_PMC_PCB_INTR_TYPE4_PENDING
IRQ_HANDLER_DEFAULT            //OCCHW_IRQ_PMC_PCB_INTR_TYPE5_PENDING
IRQ_HANDLER(p9_sgpe_stop_pig_handler, 0) //OCCHW_IRQ_PMC_PCB_INTR_TYPE6_PENDING
...
IRQ_HANDLER(p9_sgpe_stop_ipi_handler, 0) //OCCHW_IRQ_IPI3_LO_PRIORITY
