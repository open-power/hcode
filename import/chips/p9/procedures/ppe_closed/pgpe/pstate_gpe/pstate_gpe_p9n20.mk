...
#
# $Source: import/chips/p9/procedures/ppe_closed/pgpe/pstate_gpe/pstate_gpe_p9n20.mk $
#
...
#
# IBM_PROLOG_END_TAG
PSTATE_TARGET:=pstate_gpe_p9n20
IMAGE := $(PSTATE_TARGET)

$(IMAGE)_COMMONFLAGS+= -DNIMBUS_DD_LEVEL=20
