...
/*                                                                        */
/* $Source: import/chips/p10/common/include/examples/p10_acs_nochk_wrap.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
///
/// @file p10_acs_nochk_wrap.C
/// @brief Equivalent to p10_acs, but with scom checking turned off (wrapper)
///
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_acs_nochk_wrap";
