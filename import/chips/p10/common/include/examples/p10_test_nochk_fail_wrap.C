...
/*                                                                        */
/* $Source: import/chips/p10/common/include/examples/p10_test_nochk_fail_wrap.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
///
/// @file p10_test_nochk_fail_wrap.C
/// @brief Initialize island-mode fabric configuration (wrapper)
///
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_test_nochk_fail_wrap";
