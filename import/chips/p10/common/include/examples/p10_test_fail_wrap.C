...
/*                                                                        */
/* $Source: import/chips/p10/common/include/examples/p10_test_fail_wrap.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
///
/// @file p10_test_fail_wrap.C
/// @brief test accessor fail (wrapper)
///
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_test_fail_wrap";
