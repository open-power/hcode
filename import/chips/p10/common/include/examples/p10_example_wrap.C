...
/*                                                                        */
/* $Source: import/chips/p10/common/include/examples/p10_example_wrap.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
///
/// @file p10_example_wrap.C
/// @brief Simple accessor example (wrapper)
///
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_example_wrap";
