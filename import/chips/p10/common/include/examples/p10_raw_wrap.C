...
/*                                                                        */
/* $Source: import/chips/p10/common/include/examples/p10_raw_wrap.C $     */
/*                                                                        */
...
///
/// @file p10_raw_wrap.C
/// @brief Equivalent to p10_acs, but without using accessors (wrapper)
///
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_raw_wrap";
