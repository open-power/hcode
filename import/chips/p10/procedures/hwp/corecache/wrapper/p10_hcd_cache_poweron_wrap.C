...
/*                                                                        */
/* $Source: import/chips/p10/procedures/hwp/corecache/wrapper/p10_hcd_cache_poweron_wrap.C $ */
/*                                                                        */
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_hcd_cache_poweron_wrap";
...
int main(int argc, char* argv[])
{
    ...
    do
    {
        ...
        while (ecmdConfigLooperNext(drawer_target, drawer_looper))
        {
            ...
            if (!ecmdGetGlobalVar(ECMD_GLOBALVAR_QUIETMODE))
            {
                snprintf(outstr, sizeof(outstr), "Processing drawer %s\n",
