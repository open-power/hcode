...
/*                                                                        */
/* $Source: import/chips/p10/procedures/hwp/corecache/wrapper/p10_hcd_core_ras_runtime_scom_wrap.C $ */
/*                                                                        */
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_hcd_core_ras_runtime_scom_wrap";
