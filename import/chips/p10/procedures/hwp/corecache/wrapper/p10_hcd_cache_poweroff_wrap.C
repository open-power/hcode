...
/*                                                                        */
/* $Source: import/chips/p10/procedures/hwp/corecache/wrapper/p10_hcd_cache_poweroff_wrap.C $ */
/*                                                                        */
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_hcd_cache_poweroff_wrap";
    ...
    ecmdOutput(outstr);
    ecmdOutput("        [-h] [-k#] [-n#] [-s#] [-p#] [-quiet] [-verif]\n");
    ...
    do
    {
        ...
        while (ecmdConfigLooperNext(drawer_target, drawer_looper))
        {
            ...
            while(ecmdConfigLooperNext(pu_target, pu_looper))
            {
                ...
                fapi_target(&pu_target);

                fapi2::Target < fapi2::TARGET_TYPE_PROC_CHIP > chip_target;
                chip_target = fapi_target.getParent<fapi2::TARGET_TYPE_PROC_CHIP>();
