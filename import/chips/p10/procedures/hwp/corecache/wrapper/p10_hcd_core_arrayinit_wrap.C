...
/*                                                                        */
/* $Source: import/chips/p10/procedures/hwp/corecache/wrapper/p10_hcd_core_arrayinit_wrap.C $ */
/*                                                                        */
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_hcd_core_arrayinit_wrap";
    ...
    ecmdOutput(outstr);
    ecmdOutput("        [-h] [-k#] [-n#] [-s#] [-p#] [-unicast ] [-quiet] [-verif]\n");
...
int main(int argc, char* argv[])
{
    ...
    // load and initialize the eCMD Dll#include <fapi2.H>
