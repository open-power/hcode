...
/*                                                                        */
/* $Source: import/chips/p10/procedures/hwp/corecache/wrapper/p10_hcd_cache_scom_customize_wrap.C $ */
/*                                                                        */
...
{
    // procedure constants
    const std::string PROCEDURE = "p10_hcd_cache_scom_customize_wrap";
