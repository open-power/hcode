...
/*                                                                        */
/* $Source: import/chips/p10/procedures/hwp/corecache/p10_hcd_core_cache_scom_customize.C $ */
/*                                                                        */
...
///
/// @file  p10_hcd_core_cache_scom_customize.C
/// @brief
///
...
//------------------------------------------------------------------------------
// Procedure: p10_hcd_core_cache_scom_customize
//------------------------------------------------------------------------------

fapi2::ReturnCode
p10_hcd_core_cache_scom_customize(
    const fapi2::Target < fapi2::TARGET_TYPE_CORE | fapi2::TARGET_TYPE_MULTICAST > & i_target,
    RESTORE_ENTRY_TYPE i_entryType )
{
    FAPI_INF(">>p10_hcd_core_cache_scom_customize");

#ifdef __PPE_QME
//This procedure is limited to istep15/16 and QME Platform
