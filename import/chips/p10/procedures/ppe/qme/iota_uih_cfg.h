...
#define UIH_STOP_EVENT_MASKING \
    (BIT32(IDX_PRTY_LVL_SPWU_RISE) | \
     BIT32(IDX_PRTY_LVL_SPWU_FALL) | \
     BIT32(IDX_PRTY_LVL_RGWU_FAST) | \
     BIT32(IDX_PRTY_LVL_STOP_FAST) | \
     BIT32(IDX_PRTY_LVL_RGWU_SLOW) | \
     BIT32(IDX_PRTY_LVL_STOP_SLOW))
