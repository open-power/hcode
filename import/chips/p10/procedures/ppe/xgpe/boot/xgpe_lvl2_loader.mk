...
#
# $Source: import/chips/p10/procedures/ppe/xgpe/boot/xgpe_lvl2_loader.mk $
#
...
# It's important that the final included *.mk is in the $(XGPE_SRCDIR)
...
# add include paths
$(call ADD_PPEIMAGE_INCDIR,$(IMAGE),$(XGPE_SRCDIR)/boot \
        $(PK_SRCDIR)/kernel \
        $(PK_SRCDIR)/ppe42 \
        $(PK_SRCDIR)/trace \
        $(PK_SRCDIR)/$(_PPE_TYPE) \
        $(PMLIB_INCDIR)/include \
