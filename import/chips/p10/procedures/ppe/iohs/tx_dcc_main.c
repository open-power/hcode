...
void tx_dcc_main_init(t_gcr_addr* gcr_addr_i)
{
    ...
    tx_dcc_main_servo(gcr_addr_i, tx_dcc_main_max_step_i_c,  tx_dcc_main_dir_i_c,  SERVOOP_I, tx_dcc_main_min_i_c,
                      tx_dcc_main_max_i_c,  tx_dcc_main_min_samples_c, tx_dcc_main_ratio_thresh_c);
    tx_dcc_main_servo(gcr_addr_i, tx_dcc_main_max_step_q_c,  tx_dcc_main_dir_q_c,  SERVOOP_Q, tx_dcc_main_min_q_c,
                      tx_dcc_main_max_q_c,  tx_dcc_main_min_samples_c, tx_dcc_main_ratio_thresh_c);
    tx_dcc_main_servo(gcr_addr_i, tx_dcc_main_max_step_iq_c, tx_dcc_main_dir_iq_c, SERVOOP_IQ, tx_dcc_main_min_iq_c,
                      tx_dcc_main_max_iq_c, tx_dcc_main_min_samples_c, tx_dcc_main_ratio_thresh_c);
...
int tx_dcc_main_adjust(t_gcr_addr* gcr_addr_i)
{
    ...
    tx_dcc_main_servo(gcr_addr_i, 1, tx_dcc_main_dir_i_c,  SERVOOP_I,  tx_dcc_main_min_i_c,  tx_dcc_main_max_i_c,
                      tx_dcc_main_min_samples_c, tx_dcc_main_ratio_thresh_c);
                       ...
                       int32_t ratio_thresh_i)
{
    ...
    set_rx_dcc_debug(0xD071, step_size_i); //step_size_i
    set_rx_dcc_debug(0xD072, dir_i); //temp debug
    set_rx_dcc_debug(0xD073, min_tune_i); //temp debug
    set_rx_dcc_debug(0xD074, max_tune_i); //temp debug
    set_rx_dcc_debug(0xD075, op_i); //temp debug
    set_rx_dcc_debug(0xD076, SERVOOP_I); //temp debug
    set_rx_dcc_debug(0xD077, SERVOOP_Q); //temp debug
    set_rx_dcc_debug(0xD078, SERVOOP_IQ); //temp debug
    ...
    do
    {
        ...
        step_l = mult_int16(step_size_l, dir_i);
        ...
        set_rx_dcc_debug(0xD089, adj_l);
        set_rx_dcc_debug(0xD08A, dcc_last_tune_l);
        set_rx_dcc_debug(0xD08B, max_tune_i);
        set_rx_dcc_debug(0xD08C, min_tune_i);
        set_rx_dcc_debug(0xD08D, step_l);
        ...
        if (!done)
        {
            set_rx_dcc_debug(0xD090, dcc_next_tune_l);
            ...
            if((initial_comp_decision_l != comp_decision_l) | (step_size_l < step_size_i) | (step_size_l <= 1))
            {
                ...
                set_rx_dcc_debug(0xD091, step_size_l); //temp debug
            }
...
t_comp_result tx_dcc_main_compare_result(t_gcr_addr* gcr_addr_i, uint32_t min_samples_i, int32_t ratio_thresh_i)
{
    ...
    do
    {
        ...
        set_rx_dcc_debug(0xD099, vote_l);
        set_rx_dcc_debug(0xD09A, vote_p_lt_n_l);
        set_rx_dcc_debug(0xD09B, vote_p_gt_n_l);
        set_rx_dcc_debug(0xD09C, vote_total_l);
        set_rx_dcc_debug(0xD09D, min_samples_i);
        set_rx_dcc_debug(0xD09E, ratio_thresh_i);
