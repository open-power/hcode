...
#define fir_code_warning         (ppe_fir_warning_mask        >> 32)
...
// Indicate if this is a P10 DD1 H or V chiplet for workarounds.
// gcr_addr_dc (fw_gcr_bus_id) is 0 for ax0_ioo which is the only vertical chiplet (ioosv_obus18_cplt) in the P10 DD1 ioosc_obus_wrap.
static inline bool is_p10_dd1_h_chiplet()
{
