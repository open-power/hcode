...
int eo_loff_fenced(t_gcr_addr* gcr_addr, t_bank bank)
{
    ...
    else
    {
        ...
        if ( loff_setting_ovr == 0)
        {
            ...
            put_ptr_field(gcr_addr, rx_loff_inc_dec_amt0, 0b110, read_modify_write);  // 5    6
            put_ptr_field(gcr_addr, rx_loff_inc_dec_amt1, 0b011, read_modify_write);  // 4    3
            put_ptr_field(gcr_addr, rx_loff_inc_dec_amt2, 0b011, read_modify_write);  // 1    3
