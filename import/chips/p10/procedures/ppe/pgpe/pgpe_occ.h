...
typedef struct pgpe_occ
{
    ...
    uint32_t idd_accum, idd_tb_accum, idd_fit_avg_ma, idd_wof_avg_accum_ma, idd_avg_ma;
    uint32_t ics_accum, ics_tb_accum, ics_fit_avg_ma, ics_wof_avg_accum_ma, ics_avg_ma;
