...
enum  PGPE_ERR_CODE_IDX
{
    ...
    PGPE_ERR_CODE_PGPE_SAFE_MODE_IN_PSTATE_STOPPED              =   35,

    //WOF
    PGPE_ERR_CODE_PGPE_WOF_NULL_VRT_PTR                         =   36,
    PGPE_ERR_CODE_PGPE_WOF_VRT_IN_SAFE_MODE                     =   37,
    PGPE_ERR_CODE_PGPE_WOF_VRT_IN_PSTATE_STOPPED                =   38,
    PGPE_ERR_CODE_PGPE_WOF_VRT_WHILE_PENDING                    =   39,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_WHILE_PENDING                   =   40,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_IN_SAFE_MODE                    =   41,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_IN_PSTATE_STOPPED               =   42,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_ENABLE_WHEN_ENABLED             =   43,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_DISABLE_WHEN_WOF_DISABLED       =   44,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_DISABLE_IN_PSTATE_STOPPED       =   45,
    PGPE_ERR_CODE_PGPE_WOF_CTRL_ENABLE_WITHOUT_VRT              =   46,

    //ERROR Injection
    PGPE_ERR_CODE_PGPE_ACTUATE_ERROR_INJECT_CRITICAL            =   47,
    PGPE_ERR_CODE_PGPE_ACTUATE_ERROR_INJECT_INFO                =   48,
    PGPE_ERR_CODE_PGPE_FIT_ERROR_INJECT                         =   49,

    //DPLL
    PGPE_ERR_CODE_DPLL_PARITY_ERROR                             =   50,

    //VOLTAGE
    PGPE_ERR_CODE_AVSBUS_VOLTAGE_WRITE_NOT_IN_PGPE_CONTROL      =   51,
    PGPE_ERR_CODE_AVSBUS_VOLTAGE_WRITE_UNKNOWN_ERROR            =   52,
    PGPE_ERR_CODE_AVSBUS_VOLTAGE_READ_NOT_IN_PGPE_CONTROL       =   53,
    PGPE_ERR_CODE_AVSBUS_VOLTAGE_READ_UNKNOWN_ERROR             =   54,

    //CURRENT
    PGPE_ERR_CODE_AVSBUS_CURRENT_READ_NOT_IN_PGPE_CONTROL       =   55,
    PGPE_ERR_CODE_AVSBUS_CURRENT_READ_UNKNOWN_ERROR             =   56,

    //MACHINE CHECK
    PGPE_ERR_CODE_PGPE_MACHINE_CHECK                            =   57,

    PGPE_ERR_CODE_AVSBUS_VOLTAGE_WRITE_GOOD_CRC_NO_ACTION       =   58,
