...
extern VRMParms_t*          G_gppb_ext_vrm_parms;
extern PoundVOpPoint_t*     G_gppb_operating_points_set[NUM_VPD_PTS_SET];
extern PoundVSlopes_t*      G_gppb_poundv_slopes;
extern ResClkSetup_t*       G_gppb_resclk;
extern PoundWEntry_t*       G_gppb_dds[MAXIMUM_CORES];
extern PoundWEntry_AltCal_t* G_gppb_alt_cal[MAXIMUM_CORES];
extern PoundWEntry_TgtActBin_t* G_gppb_tgt_act_bin[MAXIMUM_CORES];
extern PoundWOther_t*           G_gppb_dds_other;
